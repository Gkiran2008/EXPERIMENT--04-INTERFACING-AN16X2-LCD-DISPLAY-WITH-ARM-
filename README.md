...
int main(void)
{
  ...
  Lcd_PortType ports[] = { GPIOA, GPIOA, GPIOA, GPIOA };
     ...
     Lcd_cursor(&lcd, 0,1);
     Lcd_string(&lcd, "KIRAN G");
     Lcd_cursor(&lcd, 1,1);
     Lcd_string(&lcd, "212223040095");
  /* USER CODE END 2 */
...
![WhatsApp Image 2025-04-07 at 09 35 11_2d9b7dee](https://github.com/user-attachments/assets/44313a9e-d9f5-416c-ab4d-5b1b437f482d)


 ![{F81E0287-6CDF-4A73-8CF6-03876AA28610}](https://github.com/user-attachments/assets/ffc35881-233d-41c5-a80a-4063eb9a1a9b)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 


 ![{74E48DB5-3FC1-4F7A-8902-83ED9FF3C576}](https://github.com/user-attachments/assets/b3521b1a-2c31-4d4a-a738-75921badb087)
